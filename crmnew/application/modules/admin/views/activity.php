...
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/reset.css" />
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/grid.css" />
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/style.css" />
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/messages.css" />
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/forms.css" />
<link rel="stylesheet" media="screen" href="<?=$theme_path; ?>/css/tables.css" />
...
<!-- jquerytools -->
<script type="text/javascript" src="<?=$theme_path; ?>/js/jquery.tools.min.js"></script>
...
<script type="text/javascript" src="<?=$theme_path; ?>/js/jquery.tables.js"></script>
<script type="text/javascript" src="<?=$theme_path; ?>/js/jquery.flot.js"></script>
    ...
    <div id="wrapper">
        <header>
            <div class="clearfix">
                ...
                <nav>
                    <ul class="clearfix">
                        <li class="active"><a href="<?=$theme_path; ?>dashboard">Dashboard</a></li>
